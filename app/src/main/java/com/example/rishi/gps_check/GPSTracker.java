...
public class GPSTracker extends Service implements LocationListener {
    ...
    double latitude;
    double longitude;
    private static final long MIN_DISTANCE_FOR_UPDATES = 4;
    ...
    public Location getLocation(){
        try{
            ...
            Log.d("GPSTracker","catch "+e.toString());
        }
        return location;
    }
    ...
    public void onLocationChanged(Location location) {
        ...
        mainActivity.setFirebaseValue(location.getLatitude(),location.getLongitude());
    }
    @Override
